class Platform {
  ...
  // REAL MEASUREMENTS
  private final float SCALE_INITIAL_HEIGHT = 170; //  250
  private final float SCALE_BASE_RADIUS = 80; //140
  private final float SCALE_PLATFORM_RADIUS = 62;
  private final float SCALE_HORN_LENGTH = 35;
  private final float SCALE_LEG_LENGTH = 167; // 270
